...
public class FileManager {
  ...
  public static void printEventReport(Event event) throws IOException {
    ...
    writer.printf("Starting date and time: %s%n", event.getStart().format(Event.DT_FORMAT));
    writer.printf("Ending date and time: %s%n", event.getFinish().format(Event.DT_FORMAT));
